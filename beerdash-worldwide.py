...
with tab1:
    ...
    with st.expander("🎯 Vind jouw perfecte bier"):
        st.info("""
...
with tab3:
    ...
    with col1:
        ...
        st.markdown("<h1 style='text-align: center; color: grey;'>🏆 Best rated beers</h1>", unsafe_allow_html=True)
        st.write('''---''')
    ...
    with col2:
        ...
        st.markdown("<h1 style='text-align: center; color: grey;'>💩 Worst rated beers</h1>", unsafe_allow_html=True)
        st.write('''---''')
...
with tab4:
    st.header("🌍 Internationaal Bieroverzicht: per land")
...
with tab5:
    st.header("🌍 Brew Around the World")
